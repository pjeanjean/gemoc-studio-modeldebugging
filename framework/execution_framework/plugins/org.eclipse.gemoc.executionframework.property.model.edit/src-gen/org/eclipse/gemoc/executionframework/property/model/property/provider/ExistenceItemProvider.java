...
public class ExistenceItemProvider extends TemporalPropertyItemProvider {
	...
	protected void addMinPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Existence_min_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Existence_min_feature",
								"_UI_Existence_type"),
						PropertyPackage.Literals.EXISTENCE__MIN, true, false, false,
	...
	protected void addMaxPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Existence_max_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Existence_max_feature",
								"_UI_Existence_type"),
						PropertyPackage.Literals.EXISTENCE__MAX, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Existence_type") + " " + existence.getMin();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case PropertyPackage.EXISTENCE__MIN:
		case PropertyPackage.EXISTENCE__MAX:
